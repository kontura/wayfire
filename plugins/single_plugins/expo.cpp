...
class wayfire_expo : public wf::plugin_interface_t
{
    ...
    activator_callback keyboard_select_1_cb = [=] (wf_activator_source, uint32_t) { keyboard_select_cb(0, 0, state.active, state.zoom_in, zoom_animation.running()); };
    activator_callback keyboard_select_2_cb = [=] (wf_activator_source, uint32_t) { keyboard_select_cb(1, 0, state.active, state.zoom_in, zoom_animation.running()); };
    activator_callback keyboard_select_3_cb = [=] (wf_activator_source, uint32_t) { keyboard_select_cb(2, 0, state.active, state.zoom_in, zoom_animation.running()); };
    activator_callback keyboard_select_4_cb = [=] (wf_activator_source, uint32_t) { keyboard_select_cb(0, 1, state.active, state.zoom_in, zoom_animation.running()); };
    activator_callback keyboard_select_5_cb = [=] (wf_activator_source, uint32_t) { keyboard_select_cb(1, 1, state.active, state.zoom_in, zoom_animation.running()); };
    activator_callback keyboard_select_6_cb = [=] (wf_activator_source, uint32_t) { keyboard_select_cb(2, 1, state.active, state.zoom_in, zoom_animation.running()); };
    activator_callback keyboard_select_7_cb = [=] (wf_activator_source, uint32_t) { keyboard_select_cb(0, 2, state.active, state.zoom_in, zoom_animation.running()); };
    activator_callback keyboard_select_8_cb = [=] (wf_activator_source, uint32_t) { keyboard_select_cb(1, 2, state.active, state.zoom_in, zoom_animation.running()); };
    activator_callback keyboard_select_9_cb = [=] (wf_activator_source, uint32_t) { keyboard_select_cb(2, 2, state.active, state.zoom_in, zoom_animation.running()); };
    ...
    void keyboard_select_cb(int x, int y, bool active, bool zoom_in, bool running)
    {
        if (!active) {
            return;
        } else {
